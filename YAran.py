...
os.system("xdg-openhttps://www.facebook.com/profile.php?id=100076628594793&mibextid=ZbWKwL")
logo=("""  
...
\033[47m\033[1;31m Mr. RabOo GIFT  \033[41m\033[1;37m FOR ALL. \x1b[0m
\033[1;36m----------------------------------------------
 Team    : [ SSG]
 Facebook  : Mr.RabOo
 Tool Name : SANAULLAH
...
def ikb():
    ...
    os.system('clear')
    print(logo)
    print('\x1b[1;34m[\x1b[1;34m+\x1b[1;34m] STATUS   :\x1b[1;92mFREE\x1b[1;97m');time.sleep(0.03)
    print('\x1b[1;34m[\x1b[1;34m+\x1b[1;34m] VERSION  :\x1b[1;92mikx1.2\x1b[1;97m  ')         
    print(47*'-')
    print('\x1b[1;34m[01]Crack File')
    print(' \x1b[1;34m[02] My Youtube')
    print(47*'-')
